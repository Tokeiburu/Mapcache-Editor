...
using Mapcache_Editor.ApplicationConfiguration;
using TokeiLibrary;
using Utilities;

namespace Mapcache_Editor {
	/// <summary>
	...
	public partial class App : Application {
		...
		public static void ClearTemporaryFiles() {
			GrfThread.Start(delegate {
				...
				foreach (string file in Directory.GetFiles(GrfPath.Combine(MapcacheConfiguration.ProgramDataPath, "~tmp"), "*", SearchOption.TopDirectoryOnly)) {
				...
				foreach (var directory in Directory.GetDirectories(GrfPath.Combine(MapcacheConfiguration.ProgramDataPath, "~tmp"), "*")) {
