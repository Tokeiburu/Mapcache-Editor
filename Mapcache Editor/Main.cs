	...
	public class GRFEditorMain {
		...
		public static void Main(string[] args) {
			AppDomain.CurrentDomain.AssemblyResolve += (sender, arguments) => {
				...
				string resourceName = "Mapcache_Editor.Files." + assemblyName.Name + ".dll";
				...
				string compressedResourceName = "Mapcache_Editor.Files.Compressed." + new AssemblyName(arguments.Name).Name + ".dll";
			...
			var app = new App();
			app.StartupUri = new Uri("Core\\MapcacheDialog.xaml", UriKind.Relative);
			app.Run();
		}
